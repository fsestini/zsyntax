...
\begin{theorem}
  ...
  $\mathcal{D}'$ such that
  $\seqpt{\mathcal{D}'}{\bkwseq{\Gamma}{\Delta}{C}}$.
\end{theorem}
\begin{proof}
  \begin{enumerate}
  \item Case $\init$.
    ...
    \[
      \begin{prooftree}
        \justifies
        \seqpt{init(\tyj{u}{p})}{\bkwseq{\cdot}{\tyj{u}{p}}{p}}
      \end{prooftree}
    \]
  ...
  \item Case $\copyrule$.
    ...
    \[
      \begin{prooftree}
        \seqpt{\mathcal{D}}{
          \fwdseq{\Gamma}{\Delta, \tyj{v}{A}}{C}}
        \justifies
        \seqpt{copy(v.\mathcal{D}; \tyj{v}{A})}{
          \fwdseq{\Gamma, \tyj{v}{A}}{\Delta}{C}
        }
        \using{\copyrule}
      \end{prooftree}
    \]

    Then, by inductive hypothesis, we have $\seqpt{\mathcal{D}'}{
          \bkwseq{\Gamma}{\Delta, \tyj{v}{A}}{C}}$. Hence
    ...
    \[
      \begin{prooftree}
        \[
          \[
            \seqpt{\mathcal{D}'}{
              \bkwseq{\Gamma}{\Delta, \tyj{v}{A}}{C}}
            \justifies
            \seqpt{\mathcal{D}'[z/v]}{
              \bkwseq{\Gamma}{\Delta, \tyj{z}{A}}{C}}
          \]
          \justifies
          \seqpt{\mathcal{D}'[z/v]}{
            \bkwseq{\Gamma, \tyj{v}{A}}{\Delta, \tyj{z}{A}}{C}}
          \using{weak}
        \]
        \justifies
        \seqpt{copy(z.\mathcal{D}; \tyj{v}{A})}{
          \bkwseq{\Gamma, \tyj{v}{A}}{\Delta}{C}
        }
      \end{prooftree}
    \]
