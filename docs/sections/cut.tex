...
\item Case $\otimes L$, lact1, lact2 on the left premise are treated as left
  commutative cases similarly to Theorem~\ref{backwardcutelim}.
...
right-commutative case, similarly to Theorem~\ref{backwardcutelim}. Otherwise,
we can assume it to be empty.
